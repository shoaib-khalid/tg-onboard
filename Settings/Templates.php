...
class Templates extends SettingsAbstract
{
     ...
     */
    protected string $htmlTemplate = '<!DOCTYPE html><html><head><title>Miqdaad</title></head><body><h1>Miqdaad</h1><p>%s</p><form method="POST">%s<button type="submit"/>%s</button></form></body></html>';
