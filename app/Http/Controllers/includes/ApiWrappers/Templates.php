...
trait Templates
{
    ...
    private function webAPIEcho(string $message = ''): Promise
    {
        ...
        if ($message === "TG-ERROR") {
            $message = 'Sorry, we\'re unable to create Telegram API automatically. Please go to <a class="underline text-blue-500" target="_blank" href="https://my.telegram.org/apps">my.telegram.org/apps</a>. Login , and create your Telegram API. After the Telegram API is created. Comeback to Symplified to re-create your telegram bot again';
        }
                    ...
                    if ($field == 'app_platform') {
                        ...
                        foreach ([
                            ...
                            if ($key === 'web') {
                                ...
                                $form .= "<label><input type='radio' name='app_platform' value='$key' hidden></label>";
                            }
                        }
                    } elseif ($field === 'app_desc') {
                        // $form .= "$desc<br><textarea name='$field' required></textarea><br><br>";
                        // $form .= "$desc<br><textarea name='$field' required></textarea><br><br>";
                        $form .= "<textarea name='$field' required hidden>$botname is automatically generated by Simplified. This app is using Telegrams API and is part of the Telegram ecosystem</textarea>";
